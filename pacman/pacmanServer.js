...
var screen = (function() {
    ...
    var addInput = function() {
        ...
        document.onkeydown = function(e) {
            ...
            switch (key) {
                // steer pac-man
                case 37: direction = DIR_LEFT; break;
                case 38: direction = DIR_UP; break;
                case 39: direction = DIR_RIGHT; break;
                case 40: direction = DIR_DOWN; break;
                default: return;
            }
        ...
        socket.on('player_direction', function(data) {
            _(actors[data.player]).extend(data.playerObj);
            actors[data.player].setNextDir(data.direction);
        });
